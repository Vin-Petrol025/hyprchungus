...
hl.bind(mainMod .. " + ALT + SPACE", hl.dsp.exec_cmd("wlogout --layout ~/.config/wlogout/layout --css ~/.config/wlogout/style.css"))
...
hl.bind(mainMod .. " + SLASH", hl.dsp.exec_cmd("awww img ~/.config/wallpapers/3w.png --transition-type center --transition-duration=1"))
-- hl.bind(mainMod .. " + PRIOR", hl.dsp.exec_cmd("mpvpaper -o \"loop\" eDP-1 ~/Downloads/wisteria-lake-at-night-minecraft-moewalls-com.mp4"))
hl.bind(mainMod .. " + BRACKETLEFT", hl.dsp.exec_cmd("awww img ~/.config/wallpapers/wallhaven-3zmrk3_1920x1080.png --transition-type center --transition-duration=1"))
...
hl.bind(mainMod .. " + B", hl.dsp.exec_cmd("kitty -e btop"))
